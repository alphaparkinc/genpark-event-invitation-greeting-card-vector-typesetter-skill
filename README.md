# genpark-event-invitation-greeting-card-vector-typesetter-skill
...
> **GenPark AI Agent Skill** -- Event invitation and greeting card vector typesetter & die-cut mask (AI Invitation)
